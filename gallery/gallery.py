...
image1 = ImageTk.PhotoImage(Image.open("gallery/images/fotos/01.jpg").resize((600, 350)))
image2 = ImageTk.PhotoImage(Image.open("gallery/images/fotos/02.jpg").resize((600, 350)))
image3 = ImageTk.PhotoImage(Image.open("gallery/images/fotos/03.jpg").resize((600, 350)))
image4 = ImageTk.PhotoImage(Image.open("gallery/images/fotos/04.jpg").resize((600, 350)))
image5 = ImageTk.PhotoImage(Image.open("gallery/images/fotos/05.jpg").resize((600, 350)))
